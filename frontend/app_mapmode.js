...
async function fetchNearestNode(lat, lon) {
    ...
    try {
        const res = await fetch('https://visualize-algorithm.onrender.com/get_nearest_node', {
            method: 'POST',
...
waitForLeaflet(async () => {
    ...
    try {
        const resp = await fetch('https://visualize-algorithm.onrender.com/map_data');
    ...
    if (runBtn) {
        runBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                const res = await fetch('https://visualize-algorithm.onrender.com/route', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
